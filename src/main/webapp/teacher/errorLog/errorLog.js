define(function(require, exports, module) {
    ...
    require("./errorLog.css");
    var tpl = require("./errorLog.tpl");
    ...
    var errorLog = {
        initHomeworkData: function() {
            $('#errorLogList').bootstrapTable({
                ...
                queryParams: errorLog.queryParams, // 传递参数（*）
                detailView: true,
                detailFormatter: errorLog.detailFormatter,
                pagination: true,
                search: true,
                ...
                responseHandler: errorLog.responseHandler,
                onLoadSuccess: function(result) {
                    // 解决：标题或者内容太长的情况
                    $('#errorLogList .ellip').ellipsis({
                        maxLine: 1,
                        maxWidth: 200,
                    });
                    $(".del").click(function() {
                        errorLog.delHomework($(this).data("id"));
                    });
                },
                columns: [{
                    field: 'i',
